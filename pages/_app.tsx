    ...
    <ClerkProvider {...pageProps}>
      ...
      <SignedOut>
        <div style={welcomeMsg} className={dmsans.className}>
          ...
          <div style={{fontWeight: 'bold', color: '#8A77D9', width: '70%', margin: '0 auto' }}>Our goal is to help enhance the day to day lives and assist with memory support for those in long-term memory care units.</div>
          <h4>❤️</h4>
